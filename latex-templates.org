...
#+NAME: footbarline
#+HEADERS: :var style="default" :var color="generic3"
...
#+BEGIN_SRC latex
  \ifthenelse{\boolean{has_driver_name}}{}{
    \PackageError{custom-beamer}{You must specify a 'driver' name !}{You must specify a know 'driver' name}}{
  }
#+END_SRC
