...
#+BEGIN_SRC latex
  ...
  \SetupKeyvalOptions{
   ...
   \DeclareStringOption[d2pfo]{driver}
...
#+BEGIN_SRC latex
  ...
  \ifthenelse{\equal{\cb@driver}{\@empty}}{
    \PackageError{d2pfo-beamer}{'driver' option is missing !}{You must specify a 'driver' name}}{
  ...
  \ifthenelse{\boolean{has_driver_name}}{}{
    \PackageError{d2pfo-beamer}{'\cb@driver' name is unkown !}{You must specify a know 'driver' name}}{
  }
#+END_SRC
