...
=org-mode= and =xelatex=. The second part defines some templates to be used
either with pure LaTeX document or Beamer class.
...
#+BEGIN_SRC latex
  \ifthenelse{\boolean{ls@oldstyle}}{}{
    ...
    \titleformat*{\subsubsection}{\itshape\subsubsectionfont\color{blue!60}}
  }
#+END_SRC
***** Set space line
#+BEGIN_SRC latex
...
#+END_SRC
***** Tweaking geometry
This has to be set here for obscure (maybe =fncychap= redefines geometry layout)
#+BEGIN_SRC latex
  \ifthenelse{\boolean{ls@cpp_teaching_classes}}{
...
#+BEGIN_SRC latex
  \newenvironment{remark}
                 {\begin{quote}\ding{47}\emph\small}
                 {\end{quote}}
#+END_SRC
***** Prompt
#+BEGIN_SRC latex
