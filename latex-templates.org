...
#+BEGIN_SRC latex
  ...
  \SetupKeyvalOptions{
   ...
   \DeclareBoolOption[false]{nofootbarline}
...
#+BEGIN_SRC latex
  ...
  \ifthenelse{\equal{\cb@driver}{\@empty}}{
    \PackageError{custom-beamer}{'driver' option is missing !}{You must specify a 'driver' name}}{}
#+END_SRC

**** D2PFO colors
#+BEGIN_SRC latex
  \ifthenelse{\equal{\cb@driver}{d2pfo}}{
...
**** SuperNEMO colors
#+BEGIN_SRC latex
  \ifthenelse{\equal{\cb@driver}{nemo}}{
    \setboolean{has_driver_name}{true}
    \definecolor{red}{RGB}{221,42,43}
    \definecolor{green}{RGB}{132,184,24}
    \definecolor{blue}{RGB}{0,72,112}
...
If no known driver has been found then generate an error.
#+BEGIN_SRC latex
  \ifthenelse{\boolean{has_driver_name}}{}{
    \PackageError{custom-beamer}{'\cb@driver' name is unkown !}{You must specify a know 'driver' name}}{
  }
#+END_SRC
...
#+BEGIN_SRC latex :noweb yes
  \ifthenelse{\boolean{cb@nofootbarline}}{
    \defbeamertemplate{footline}{footbarline}{%
      \usebeamerfont{page number in head/foot}
      \hspace{1em}\insertshortdate\,-\,\insertshortauthor\hfill
